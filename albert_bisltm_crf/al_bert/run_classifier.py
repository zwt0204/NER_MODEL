...
from zwt.NER.albert_ner.al_bert import optimization_finetuning as optimization
...
# Required parameters
flags.DEFINE_string(
    "data_dir", 'D:\\gitwork\\script\\data\\albert_base_zh\\data',
...
flags.DEFINE_string("vocab_file", 'D:\\gitwork\\script\\data\\albert_base_zh\\vocab.txt ',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", 'D:\\gitwork\\script\\data\\albert_base_zh\\model',
    "The output directory where the model checkpoints will be written.")

# Other parameters

flags.DEFINE_string(
    "init_checkpoint", 'D:\\gitwork\\script\data\\albert_base_zh\\albert_model.ckpt',
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        if ln_type == 'preln':
            # add by brightmart, 10-06. if it is preln, we need to an additonal layer: layer normalization
            # as suggested in paper "ON LAYER NORMALIZATION IN THE TRANSFORMER ARCHITECTURE"
...
class SelfProcessor_test(DataProcessor):
...
if __name__ == "__main__":
    ...
    """
    python run_classifier.py  --task_name=lcqmc_pair  --do_train=true  --do_eval=true  --data_dir=./LCQMC  --vocab_file=./albert_config/vocab.txt  --bert_config_file=./albert_config/albert_config_large.json --max_seq_length=128 --train_batch_size=64  --learning_rate=2e-5  --num_train_epochs=3  --output_dir=albert_large_lcqmc_checkpoints  --init_checkpoint=./albert_base_zh/albert_model.ckpt
    """
